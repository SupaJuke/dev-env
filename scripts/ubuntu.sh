...
echo $PASSWORD | sudo -Sk apt-fast install -y bat
echo $PASSWORD | sudo -Sk apt-fast install -y ca-certificates
...
echo $PASSWORD | sudo -Sk apt install -y ./ripgrep_13.0.0_amd64.deb
